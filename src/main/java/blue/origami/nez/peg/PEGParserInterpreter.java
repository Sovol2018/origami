...
public class PEGParserInterpreter
		extends ExpressionVisitor<Optional<PEGParserInterpreter.ParseResult>, PEGParserInterpreter.ParserContext>
		implements OptionalFactory<PEGParserInterpreter> {
	...
	@Override
	public PEGParserInterpreter clone() {
		// TODO Auto-generated method stub
		return null;
	}
